    	...
    	$.ajax({
    		...
    		success: function(data) {
    			...
    			var $clonedTemplate = $(".to-clone").clone(),
                    ...
                    $cond = $clonedTemplate.find(".weather-text .condition"),
                    $description = $clonedTemplate.find(".weather-text .description"),
    				comma = ",",
                ...
                if(validInputText === city.toLowerCase()) {
                    ...
                    $description.text(condDescription);

                    $clonedTemplate.removeClass("to-hide to-clone");
                    $(".weather").prepend($clonedTemplate);
                } else {
                    $error.fadeIn();
                }
                input.val("");
